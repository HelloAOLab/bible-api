...
describe('CodexParser', () => {
    ...
    describe('parse', () => {
        ...
        it('should parse a scripture cell into verses', () => {
            const tree = parser.parse(JSON.stringify({
                cells: [
                    {
                        kind: 2,
                        language: 'scripture',
                    ...
                    },
                    {
                        ...
                        content: [
                            ...
                            },
                            {
                                type: 'verse',
                                number: 2,
                                content: ['إينّا: «غريخ إ يهويه ربّي ݣ-ثمارانو إيجَاوبِي، زݣ آيث ليخرا سغُويّخاشن أيهويه ربّي نو، تسفلت إ تغُويّيت إينو.']
                            },
                        ],
                        footnotes: [],
                    }
                    ...
                    },
                    {
                        ...
                        content: [
                            ...
                            },
                            {
                                type: 'verse',
                                number: 1,
                                content: ['داي إيسيول ربّي إ يونان المرث ثيسناث إينّاس:']
                            },
                            {
                                type: 'line_break',
                            },
                            {
                                type: 'verse',
                                number: 2,
                                content: ['«كّر الدّو غرنينوى ثمدينث تاخاثارث، ثسغويث دييس سوينّا الدّيخ أداش إينيخ».']
                            }
                        ],
                        footnotes: [
                            {
                    ...
                    },
                    {
                        ...
                        content: [
                            ...
                            },
                            {
                                type: 'verse',
                                number: 1,
                                content: ['داي إسطّيراست أوينّا إيونان شيݣان، إيسغوس أُوولنس.']
                            },
                            {
                                type: 'verse',
                                number: 2,
                                content: ['أها إيژّال إتر إ ربّي إينّا: «عفاش أ يهويه ربّي إيس أوريد أوال إينو أيا النّا النّيخ أيللّيݣ سولخ يتمازيرت إينو أينّاخ أس الكّيخ ريخ أدرولخ غر ترشيش إتخ سنخ إيد شݣ ربّي أرحيم أحنين وريزربن ي الغظب نس إيعدّا ليخلاص نّش أرتسمهالث ثيثي خف أونّا يخّان.']
                            }
                        ],
                        footnotes: [
                            {
