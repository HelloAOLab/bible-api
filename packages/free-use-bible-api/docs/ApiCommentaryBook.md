...
| `firstChapterReference` | [CommentaryChapterReference](CommentaryChapterReference.md) |
| `lastChapterNumber`     | number                                                      |
| `lastChapterApiLink`    | string                                                      |
| `lastChapterReference`  | [CommentaryChapterReference](CommentaryChapterReference.md) |
