...
| `firstChapterReference` | [TranslationChapterReference](TranslationChapterReference.md) |
| `lastChapterNumber`     | number                                                        |
| `lastChapterApiLink`    | string                                                        |
| `lastChapterReference`  | [TranslationChapterReference](TranslationChapterReference.md) |
